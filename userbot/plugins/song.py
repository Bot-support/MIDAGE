...
"""Only MIDAGE BOT and DC (Can Use Without Credits) Can Use This Inline WithOut Copyright (Just Give The Credits Pls)
...
if BOT_MSG is None:
    ...
    BOT_LIT = f"Hello Sir MySelf MIDAGE BOT Here For  {LIGHTNINGUSER}'s Protection "
