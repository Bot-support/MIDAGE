...
async def startgmute(event):
    ...
    if event.fwd_from:
        ...
        await event.edit("Muh me lwda de rha ruko bhsdk!!")
    ...
    try:
        ...
        await event.edit("Or beta Bap se backchodi. Can't speek now.... Filled His Mouth With Cum😉")
...
async def endgmute(event):
    ...
    if event.fwd_from:
        ...
        await event.edit("Chal beta mera lwda chor ab....\n\n       Today Sex Done😁 ")
        await asyncio.sleep(3)
        private = True
    reply = await event.get_reply_message()
    if event.pattern_match.group(1) is not None:
