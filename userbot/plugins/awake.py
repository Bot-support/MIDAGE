...
async def amireallyalive(awake):
   ...
   ALIVE_MESSAGE += "🔶 𝙼𝙸𝙳𝙰𝙶𝙴 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 🔶 :   2.0\n\n"
   ALIVE_MESSAGE += f"🔷 𝚄𝙿𝚃𝙸𝙼𝙴 🔷 : {uptm}\n\n"
   ALIVE_MESSAGE += f"💠 𝙼𝚈 𝙱𝙾𝚂𝚂 💠: [{DEFAULTUSER}](tg://user?id={tag})\n\n"
   ALIVE_MESSAGE += "🔰 𝙶𝚁𝙾𝚄𝙿 🔰 : [SUPPORT](https://t.me/Midage_userbot)\n\n"
   ALIVE_MESSAGE += f"💠 [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Fbot-support%2FMIDAGE&template=https%3A%2F%2Fgithub.com%2Fbot-support%2FMIDAGE) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/bot-support/MIDAGE)  💠\n"   
   await awake.delete() 
