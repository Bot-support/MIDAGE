...
#make by BLAZE for chutiapa 🤔🤔🤔 you dont kang this 
...
BOT = str(botnickname) if botnickname else "𝙼𝙸𝙳𝙰𝙶𝙴 𝚄𝚂𝙴𝚁𝙱𝙾𝚃"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "𝙼𝙸𝙳𝙰𝙶𝙴"
...
#my name 👇
𝗗𝗘𝗩𝗜𝗟 = "[BLAZE](https://t.me/piroXpower)"
#my bots repo 👇
REPO = "[MID AGE](https://github.com/Arcane120/ArcaneOpBot)"
...
ALIVE = "MIDAGE υѕєяησт ιѕ ση🔥 ƒιяє 🔥" #make by ∂єνιℓ
OP = "𝙷𝙴𝙻𝙻𝙾 𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 MIDAGE  𝚄𝚂𝙴𝚁𝙱𝙾𝚃 𝙸 𝙰𝙼 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚄𝚂𝙴𝚁𝙱𝙾𝚃💝"
EMOJI = "🔥"
